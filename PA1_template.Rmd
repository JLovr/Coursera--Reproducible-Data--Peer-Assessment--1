...
p<-p+ylab("Nu4 mber of Steps")
p<-p+facet_wrap(~daytype,nrow=2)
print(p)
```


From the plot, we can see that there is noticeably less activity on weekdays between the 900 and 1700 interval marks, possibly corresponding to the lower movement activity of day shift office workers on weekdays.
